...
def gen_boxplots(csv_file, num_cols=3):
    ...
    # Selecting only the desired columns
    selected_columns = df[["CGP_gens1_popSize50_MUT10_lookback2_dims(5,5) - test_accuracy", 
                        "CGP_gens10_popSize50_MUT10_lookback2_dims(5,5) - test_accuracy",
                        "CGP_gens100_popSize50_MUT10_lookback2_dims(5,5) - test_accuracy",]]
    
    # Renaming the columns
    selected_columns = selected_columns.rename(columns={
        "CGP_gens1_popSize50_MUT10_lookback2_dims(5,5) - test_accuracy": "Gens 1",
        "CGP_gens10_popSize50_MUT10_lookback2_dims(5,5) - test_accuracy": "Gens 10",
        "CGP_gens100_popSize50_MUT10_lookback2_dims(5,5) - test_accuracy": "Gens 100",
    })
...
def pop_boxplots(csv_file, num_cols=3):
    # Load data from CSV file
    df = pd.read_csv(csv_file)
    ...
    # Selecting only the desired columns
    selected_columns = df[["CGP_gens100_popSize50_MUT10_lookback2_dims(5,5) - test_accuracy", 
                        "CGP_gens100_popSize100_MUT20_lookback2_dims(5,5) - test_accuracy",
                        "CGP_gens100_popSize500_MUT20_lookback2_dims(5,5) - test_accuracy",]]
    
    # Renaming the columns
    selected_columns = selected_columns.rename(columns={
        "CGP_gens100_popSize50_MUT10_lookback2_dims(5,5) - test_accuracy": "Population 50 (+1)",
        "CGP_gens100_popSize100_MUT20_lookback2_dims(5,5) - test_accuracy": "Population 100 (+1)",
        "CGP_gens100_popSize500_MUT20_lookback2_dims(5,5) - test_accuracy": "Population 500 (+1)",
    })
    ...
    # Customize boxplot elements
    plt.title('Boxplot for different number of individuals', fontweight='bold', fontsize=FONT_SIZE)
